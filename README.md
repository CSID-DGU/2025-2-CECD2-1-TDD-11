...
## 프로젝트 소개
**Life Bookshelf (인생책장)** - AI 기반 자서전 생성 인터뷰 시스템

사용자와의 대화형 인터뷰를 통해 삶의 이야기를 수집하고, AI가 자동으로 자서전을 생성하는 서비스입니다.

- **플랫폼**: Web, Android App
- **개발 툴**: FastAPI, Spring Boot, Kotlin, React
- **개발 기간**: 2025년 2학기
- **핵심 기술**: 
  - AI 기반 지능형 인터뷰 (6W 축 분석)
  - 유사도 기반 소재 매칭 (Semantic Search)
  - LLM 기반 자서전 자동 생성
