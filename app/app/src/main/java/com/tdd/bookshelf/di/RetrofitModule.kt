...
import com.tdd.bookshelf.BuildConfig
import com.tdd.core.util.isJsonArray
import com.tdd.core.util.isJsonObject
...
object RetrofitModule {
    ...
    fun provideOkHttpClient(
        ...
        @BookShelfRetrofit interceptor: Interceptor,
    ): OkHttpClient =
    ...
    fun providesRetrofit(
        @BookShelfRetrofit okHttpClient: OkHttpClient,
    ): Retrofit =
        Retrofit.Builder()
